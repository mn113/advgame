...
// Define the geography of level0 (demo)
MYGAME.rooms[0] = {
	walkboxes: {
	...
	exits: {},
	entities: {}	// Could store fixed items and default items/characters in this object
};

// Define the content of level0:	// ALL CURRENTLY GLOBALS
(function(M, $) {
	...
	// Initialise exits:
	var exit1 = new M.Exit($(".exit"), "exit1", null, true, false).placeAt([100,0]);	// Visible but inactive
